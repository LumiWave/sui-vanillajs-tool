...
var stringifyDocument = e => {
  ...
  if ("string" == typeof e) {
    ...
    n = h.get(e) || sanitizeDocument(r.print(e));
    h.set(e, n);
  }
...
var getPeerSupportedFeatures = () => {
  if (!O) {
    var e = new n.GraphQLSchema({
      query: new n.GraphQLObjectType({
        name: "Query",
        fields: {
          _noop: {
            type: n.GraphQLID
    ...
    return O = r.data ? toSupportedFeatures(r.data) : w;
  }
  return O;
};
...
var toTSConfigPath = e => ".json" !== s.extname(e) ? s.resolve(A, e, "tsconfig.json") : s.resolve(A, e);
...
exports.outputIntrospectionFile = function outputIntrospectionFile(e, n) {
  if (/\.d\.ts$/.test(n.fileType)) {
    ...
    return [ L, _, `const introspection = ${t} as const;\n`, "export { introspection };" ].join("\n");
  }
