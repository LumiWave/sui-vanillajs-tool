...
import { GraphQLSchema as a, GraphQLObjectType as n, GraphQLID as t, executeSync as i, buildClientSchema as o, buildSchema as s } from "graphql";

import { Kind as u, GraphQLError as l, parse as d, print as c, OperationTypeNode as f } from "@0no-co/graphql.web";

import * as p from "node:fs/promises";

import m from "node:fs/promises";

import v from "typescript";
...
var rehydrateGraphQlError = e => {
  if (e && e.message && (e.extensions || "GraphQLError" === e.name)) {
    ...
    return new l(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {});
  } else {
    return new l(e);
  }
};
...
var stringifyDocument = e => {
  ...
  if ("string" == typeof e) {
    ...
    r = A.get(e) || sanitizeDocument(c(e));
    A.set(e, r);
  }
...
var x = function Client(e) {
  ...
  var d = this instanceof Client ? this : Object.create(Client.prototype);
  var c = Object.assign(d, {
    ...
    createRequestOperation(e, a, n) {
      ...
      return makeOperation(e, a, {
        ...
        suspense: n.suspense || !1 !== n.suspense && c.suspense
      });
    },
    ...
    executeQuery(e, r) {
      var a = c.createRequestOperation("query", e, r);
      return c.executeRequestOperation(a);
    },
    executeSubscription(e, r) {
      var a = c.createRequestOperation("subscription", e, r);
      return c.executeRequestOperation(a);
    },
    executeMutation(e, r) {
      var a = c.createRequestOperation("mutation", e, r);
      return c.executeRequestOperation(a);
    },
    readQuery(e, r, a) {
      var n = null;
      subscribe((e => {
        n = e;
      }))(c.query(e, r, a)).unsubscribe();
      return n;
    },
    query: (e, r, a) => c.executeQuery(createRequest(e, r), a),
    subscription: (e, r, a) => c.executeSubscription(createRequest(e, r), a),
    mutation: (e, r, a) => c.executeMutation(createRequest(e, r), a)
  });
  var f = noop;
  if ("production" !== process.env.NODE_ENV) {
...
function loadFromSDL(e) {
  ...
  return {
    ...
    load: async e => e || !t ? t = await load() : t,
    notifyOnUpdate(r) {
      if (!a.size) {
        (async () => {
          n = new AbortController;
          var r = m.watch(e.file, {
            signal: n.signal,
            persistent: !1
          });
          try {
            for await (var i of r) {
              if (t = await load()) {
                for (var o of a) {
                  o(t);
                }
...
var retryExchange = e => {
  ...
  return ({forward: e, dispatchDebug: s}) => u => {
    var {source: l, next: d} = makeSubject();
    var c = mergeMap((e => {
      ...
      r.delay = l;
      var c = filter((r => ("query" === r.kind || "teardown" === r.kind) && r.key === e.key))(u);
...
var stat = (e, r = isFile) => p.stat(e).then(r).catch((() => !1));
...
var readTSConfigFile = async e => {
  ...
  var a = await p.readFile(r, "utf8");
  var n = v.parseConfigFileTextToJson(r, a);
  if (n.error) {
...
function outputIntrospectionFile(e, r) {
  if (/\.d\.ts$/.test(r.fileType)) {
    ...
    return [ q, V, `const introspection = ${t} as const;\n`, "export { introspection };" ].join("\n");
  }
